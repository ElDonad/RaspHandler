...
//            {
//                if ((*it)->getType() == AiguillageHandlerEvent::AiguillageHandlerEventTypes::AlimentationAdded)//si les callbacks sont bien appropri�s
//                {
//                    if ((*it)->alimentationAddedEvent.done == true)//si tout s'est pass� correctement
//                    {
        ...
        case UserEvent::UserEventTypes::ChangeAiguillageState:
            {
                ...
                std::vector<std::shared_ptr<AiguillageHandlerEvent>> errors;//� impl�menter la s�curit�
...
// TODO (Elie#2#): Eventuellement lancer �galement le signal ChangingAiguillageStateAbortes/Confirmed (et g�rer les erreurs aussi...)
...
//                if (previousId != 0)//si tout s'est bien pass�
//                {
//                    m_aiguillageHandlers.push_back(std::unique_ptr<AiguillageHandler>(event->registerHandlerEvent.aiguillageHandlerToRegister));
    ...
    case AiguillageHandlerEvent::AiguillageHandlerEventTypes::AiguillageAdded:
        {
            ...
            if (event->aiguillageAddedEvent.done == true)//r�ussi
            {
        ...
        case AiguillageHandlerEvent::AiguillageHandlerEventTypes::AlimentationAdded:
            {
                std::cout<<"Signal provisoire : alimentation ajout�e (depuis l'aiguillageManager)"<<std::endl;
                break;
            }
        case AiguillageHandlerEvent::AiguillageHandlerEventTypes::AlimentationDeleted:
            {
                std::cout<<"Signal provisoire : alimentation supprim�e (depuis l'aiguillageManager)"<<std::endl;
                break;
            }
