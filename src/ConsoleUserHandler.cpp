...
void ConsoleUserHandler::m_handler()
{
    while (m_stop == false)
    {
        ...
        if (retour == "1")//liste
        {
            ...
            cout<<endl<<"> Pour en savoir plus sur un aiguillage, tapez son num�ro d'identifiant. sinon, tapez 'x'. ";
            bool quit = false;
            while (quit == false)
            {
        ...
        {
            cout<<"> Entrez le type de l'aiguillage (se r�f�rer � la documentation)"<<endl;
            string retour = safeWaitForEntry();
            ...
            if (retour == "SimpleAiguillage1")
            {
                ...
                cout<<endl<<"> Entrez la direction de base de l'aiguillage (pin d�sactiv�)(g/d) : ";
                string direction = "";
                ...
                while (done == false)
                {
                    ...
                    {
                        cout<<endl<<"Tu pourrais la refaire en te gourant pas s'il te pla�t ?"<<endl;
                    }
                }
                cout<<endl;
                ...
                for (auto it = toFill.begin(); it != toFill.end(); ++it)
                {
                    ...
                    {
                        cout<<"Bug de typage de donn�e !!"<<endl;
                    }
                }
        ...
        else if (retour == "3")//manipuler les aiguillages
        {
            ...
            cout<<endl;
            directionId = getSafeInt("Entrez la direction souhait�e : ") - 1;
        ...
        else if (retour == "4")//Gestionnaire d'Alimentation
        {
            ...
            cout<<">3. Supprimer une alimentation(les aiguillages qui en d�pendent deviendront indisponibles"<<endl;
            retour = safeWaitForEntry();
            ...
            else if (retour == "2")//ajouter une alimentation
            {
                ...
                //r�cup�ration de l'id de l'eventHandler
                bool done = false;
                while (done == false)
                {
                    try
                    {
                        cout<<">S�lectionnez l'EventHandler h�te en inscrivant son id : ";
                        retour = safeWaitForEntry();
                    ...
                    {
                        cout<<endl<<"Andouille, tu �cris n'importe quoi ! recommence !"<<endl;
                        continue;
                    }
                }
                cout<<endl;
                ...
                while (done == false)
                {
                    try
                    {
                        cout<<"Entrez le pin utilis� par l'alimentation : ";
                        retour = safeWaitForEntry();
...
//        {
//            cout<<"> S�lectionnez un aiguillage :"<<endl;
...
//                        cout<<endl<<"Requ�te envoy�e !"<<endl;
//                    }
...
//        }
        ...
        {
            cout<<"Retour demand�"<<endl;
            std::shared_ptr<UserEvent> stopEvent(new UserEvent(UserEvent::Stop));
            stopEvent->stopEvent.raison = "Arr�t initi� par le client console";
...
void ConsoleUserHandler::receiveAnswer(std::shared_ptr<BaseEvent> answer)
{
    ...
    case BaseEvent::AddingAiguillageAborted:
        {
            ...
            {
                cout<<"> L'ajout de l'aiguillage a �chou� pour les raisons suivantes :"<<endl;
    ...
    case BaseEvent::AddingAiguillageConfirmed:
        {
            if (isConcerned(answer->getId()) == true)
            {
                cout<<"Aiguillage "<<m_parentEventHandler->findAiguillageById(answer->addingAiguillageConfirmedEvent.aiguillageHandlerId,answer->addingAiguillageConfirmedEvent.aiguillageId, nullptr).second.lock()->getTag()<<" ajout� avec succ�s"<<endl;
            }
            break;
    ...
    case BaseEvent::AiguillageAdded:
        {
            cout<<"Aiguillage "<<m_parentEventHandler->findAiguillageById(answer->aiguillageAddedEvent.handlerId, answer->aiguillageAddedEvent.aiguillageId, nullptr).second.lock()->getTag()<<" ajout�."<<endl;
            break;
        }
